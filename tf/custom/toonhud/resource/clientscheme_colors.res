Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"40 40 40 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"0 0 0 102" // Shadow color
		...
		"G_LightGrey"			"217 217 217 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"21 21 21 179" // Transparent menu color
		"G_PanelBg"				"21 21 21 179" // Panel color
		"G_OpaquePanelBg"		"21 21 21 255" // Opaque Panel color
		"G_Warning"				"255 255 255 255" // Warning color
		"G_HealthValue"			"255 255 255 255" // Health value color
		"G_Overheal"			"170 251 119 255" // Overhealed health value color
		"G_LowHealthValue"		"200 67 66 255" // Low health value color
		...
		"G_MetalValue"			"217 217 217 255" // Metal color
		"G_MetalIcon"			"217 217 217 255" // Metal icon color
		"G_HeadsValue"			"217 217 217 255" // Heads value color
		"G_HeadsLabel"			"217 217 217 255" // Heads value icon color
		"G_KillstreakValue"		"217 217 217 255" // Killstreak value color
		"G_KillstreakIcon"		"217 217 217 255" // Killstreak icon color
		"G_StickyColor"					"217 217 217 255" // Stickybomb color
		"G_StickyIconColor"				"217 217 217 255" // Stickybomb icon color
		...
		"G_TargetHealthValueShadow" 	"0 0 0 102" // Target ID health value shadow color
		...
		"G_Footer"					"25 25 25 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"204 200 198 255" // Footer text color
		"G_DimmFooterText"			"204 200 198 120" // Dimm Footer text color
		...
		"G_BackpackItemBg"			"32 32 32 255" // Backpack item bg color
		"G_LoadoutItemBg"			"32 32 32 255" // Loadout item bg color
		"G_MenuBg"					"25 25 25 255" // Menu bg color
		"G_MenuText"				"204 200 198 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"204 200 198 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"32 32 32 255" // Item description panel bg
		"G_ButtonBg"				"50 50 50 255" // Button bg color
		"G_ButtonText"				"204 200 198 255" // Button text color
		"G_ButtonHoverBg"			"156 53 51 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"125 50 50 255" // Button selected bg color
		"G_ButtonSelectedText"		"204 200 198 255" // Button selected text color
		...
		"G_ItemMeterBg"				"0 0 0 64" // Item meter bg
		"G_ItemMeterBorder"			"0 0 0 0" // Item meter border color
		"G_MenuShader"				"0 0 0 77" // Menu shader color
		"G_XPBar"					"232 202 172 255" // XP Bar color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"172 251 97 255" // Crosshair1 color
		"G_Crosshair2Color"		"238 220 86 255" // Crosshair2 color
		...
		"TFOrange"			"40 40 40 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"40 40 40 255" // Highlight color
		Slider.TextColor			"204 200 198 255" // Menu text color
		Slider.TrackColor			"204 200 198 255" // Menu text color
		Slider.DisabledTextColor1	"204 200 198 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"204 200 198 120" // Dimm Menu text color
